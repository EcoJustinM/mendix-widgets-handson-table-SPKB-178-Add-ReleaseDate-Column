  ...
  onBeforeChange = (changes: any, source: any) => {
    if (source === "edit" || source === 'CopyPaste.paste') {
      return changes.map((change: any) => {
        ...
        // Check if the current round is greater than 1
        if (this.round > 1 && (col === 6 || col === 7)) {
          // Prevent lowering the value in columns 6 or 7 unless it is made blank
        ...
        console.log('onBeforeChange return change', change);
        return change;
      });
    }
  }
